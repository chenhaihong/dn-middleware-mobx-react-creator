...
*/
var aa=__webpack_require__(7),ca=__webpack_require__(3),m=__webpack_require__(26),p=__webpack_require__(10),v=__webpack_require__(8),da=__webpack_require__(27),ea=__webpack_require__(28),fa=__webpack_require__(29),ha=__webpack_require__(11);
...
var _nameBox = __webpack_require__(115);

var _nameBox2 = _interopRequireDefault(_nameBox);

var _typeGroup = __webpack_require__(117);

var _typeGroup2 = _interopRequireDefault(_typeGroup);

var _moreCheckbox = __webpack_require__(119);

var _moreCheckbox2 = _interopRequireDefault(_moreCheckbox);

var _buttonBox = __webpack_require__(121);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    }, _this.onChangeMore = function (e) {
      var _this$setState;

      var name = e.target.name;
      var checked = e.target.checked;

      _this.setState((_this$setState = {}, _this$setState[name] = checked, _this$setState));
    }, _this.onConfirm = function (e) {
      var reg = /^[a-zA-Z][a-zA-Z0-9\_\-]*$/i;
      if (!reg.test(_this.state.name)) {
        alert('名称不合法！名称只能包含字母、数字、下划线、中横线，且首字符为字母。');
        return;
      }
      _this.setState({ is_loading: true });
      _axios2.default.get('/create', {
        params: (0, _extends3.default)({}, _this.state)
  ...
  App.prototype.render = function render() {
    var _state = this.state,
        name = _state.name,
        type = _state.type,
        is_page = _state.is_page,
        is_service = _state.is_service,
        is_mock = _state.is_mock;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_nameBox2.default, { name: name, onChangeName: this.onChangeName }),
      _react2.default.createElement(_typeGroup2.default, { type: type, onChangeType: this.onChangeType }),
      type === 'controller' && _react2.default.createElement(_moreCheckbox2.default, { is_page: is_page, is_service: is_service, is_mock: is_mock, onChangeMore: this.onChangeMore }),
      _react2.default.createElement(_buttonBox2.default, { onConfirm: this.onConfirm })
    );
  };
...
var nameBox = function (_Component) {
  (0, _inherits3.default)(nameBox, _Component);

  function nameBox() {
    var _temp, _this, _ret;

    (0, _classCallCheck3.default)(this, nameBox);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.onChange = function (e) {
      _this.props.onChangeName && _this.props.onChangeName(e);
    }, _this.renderInput = function () {
      var name = _this.props.name.name;


      return _react2.default.createElement('input', { className: 'item', type: 'text', value: name, onChange: _this.onChange });
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }

  nameBox.prototype.render = function render() {
    return _react2.default.createElement(
      'fieldset',
      { className: 'nameBox' },
      _react2.default.createElement(
...
var typeGroup = function (_Component) {
  (0, _inherits3.default)(typeGroup, _Component);

  function typeGroup(props) {
    (0, _classCallCheck3.default)(this, typeGroup);

    var _this = (0, _possibleConstructorReturn3.default)(this, _Component.call(this, props));

    _this.onChange = function (e) {
      _this.props.onChangeType && _this.props.onChangeType(e);
    };

    _this.renderRadios = function () {
      var type = _this.props.type;

      var arr = ['component', 'controller', 'mock', 'model', 'page', 'service'];

      return arr.map(function (item, idx) {
        var isChecked = item === type;
        return _react2.default.createElement(
          'label',
          { className: 'item', key: item, htmlFor: item },
          _react2.default.createElement('input', { id: item, name: 'type', type: 'radio', value: item,
            checked: isChecked, onChange: _this.onChange }),
          _react2.default.createElement(
            'span',
            null,
            item
  ...
  typeGroup.prototype.render = function render() {
    return _react2.default.createElement(
      'fieldset',
      { className: 'typeGroup' },
      _react2.default.createElement(
...
var moreCheckbox = function (_Component) {
  (0, _inherits3.default)(moreCheckbox, _Component);

  function moreCheckbox(props) {
    (0, _classCallCheck3.default)(this, moreCheckbox);

    var _this = (0, _possibleConstructorReturn3.default)(this, _Component.call(this, props));

    _this.onChange = function (e) {
      _this.props.onChangeMore && _this.props.onChangeMore(e);
    };

    _this.renderCheckboxs = function () {
      var _this$props = _this.props,
          is_page = _this$props.is_page,
          is_service = _this$props.is_service,
          is_mock = _this$props.is_mock;

      var arr = [];

      arr.push(_react2.default.createElement(
        'label',
        { className: 'item', key: 'is_page' },
        _react2.default.createElement('input', { type: 'checkbox', name: 'is_page', checked: is_page, onChange: _this.onChange }),
        _react2.default.createElement(
          'span',
          null,
          'page'
      ...
      arr.push(_react2.default.createElement(
        'label',
        { className: 'item', key: 'is_service' },
        _react2.default.createElement('input', { type: 'checkbox', name: 'is_service', checked: is_service, onChange: _this.onChange }),
        _react2.default.createElement(
          'span',
          null,
          'service'
      ...
      arr.push(_react2.default.createElement(
        'label',
        { className: 'item', key: 'is_mock' },
        _react2.default.createElement('input', { type: 'checkbox', name: 'is_mock', checked: is_mock, onChange: _this.onChange }),
        _react2.default.createElement(
          'span',
          null,
          'mock'
  ...
  moreCheckbox.prototype.render = function render() {
    return _react2.default.createElement(
      'fieldset',
      { className: 'moreCheckbox' },
      _react2.default.createElement(
        'legend',
        { className: 'title' },
        '\u662F\u5426\u751F\u6210\u8FD9\u4E9B\u6A21\u677F\uFF1F'
...
var buttonBox = function (_Component) {
  (0, _inherits3.default)(buttonBox, _Component);
  ...
  function buttonBox() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.onClick = function (e) {
      _this.props.onConfirm && _this.props.onConfirm(e);
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }

  buttonBox.prototype.render = function render() {
    return _react2.default.createElement(
      'div',
      { className: 'buttonBox' },
      _react2.default.createElement(
